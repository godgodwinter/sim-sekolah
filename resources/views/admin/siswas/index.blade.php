    ...
    <div class="panel panel-default panel-table">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="/admin/siswas" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="email" class="form-control @error('users_email') is-invalid @enderror" type="email"
                                            placeholder="Masukkan Email" name="users_email" value="{{old('users_email')}}">
                                            @error('users_email')
                                            <div class="col-sm-8">
                                                <small id="passwordHelp" class="text-danger">
                                                    {{$message}}.
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="moodle_user" class="form-control @error('moodle_user') is-invalid @enderror" type="text"
                                            placeholder="Masukkan Username Ujian" name="moodle_user" value="{{old('moodle_user')}}">
                                            @error('moodle_user')
                                            <div class="col-sm-8">
                                                <small id="passwordHelp" class="text-danger">
                                                    {{$message}}.
