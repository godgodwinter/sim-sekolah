...
Route::group(['middleware' => ['is_admin']], function() {
    ...
    Route::get('admin/tagihansiswas/edittagihansiswas/{tapel}/{kelas}/{id}', [App\Http\Controllers\AdminTagihanSiswaController::class, 'edittagihansiswas'])->name('tagihansiswa.edittagihansiswas')->middleware('is_admin');
    Route::post('admin/tagihansiswas/hapusbayar/{tapel}/{kelas}/{id}/{detail_id}', [App\Http\Controllers\AdminTagihanSiswaController::class, 'hapusbayar'])->name('tagihansiswa.hapusbayar')->middleware('is_admin');
